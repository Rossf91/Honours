...
#ifndef _processor_pipline_encore_5_h_
#define _processor_pipline_encore_5_h_
...
// Vanilla 5-stage EnCore Castle pipeline
//
class ProcessorPipelineEncore5 : public ProcessorPipelineInterface {
public:
  
  ProcessorPipelineEncore5()  { /* EMPTY */ }
  ~ProcessorPipelineEncore5() { /* EMPTY */ }
  
  virtual bool precompute_pipeline_model(arcsim::isa::arc::Dcode& inst,
                                         const IsaOptions&        isa_opts);

  virtual bool update_pipeline(arcsim::sys::cpu::Processor& cpu);
...
#endif /* _processor_pipline_encore_5_h_ */
